      ...
      <div className="bg-gray-100 min-h-screen p-8">
        <div className="max-w-7xl mx-auto py-12 px-6 sm:px-8 lg:px-10 bg-white shadow-lg rounded-lg">
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-8">
            ...
            to our patients. We are dedicated to the highest standards of
            medical care, ensuring that every patient receives compassionate,
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            ...
            that every patient is unique and deserves customized care. We work
            closely with patients and their families to develop personalized
            treatment plans that address their specific health needs. Our
            multidisciplinary team of doctors, nurses, and healthcare
            professionals ensures that each patient’s medical history, current
          ...
          <ul className="list-disc pl-6 text-lg text-gray-700 mb-6">
            <li>Comprehensive patient health records management</li>
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            Our vision is to create a healthcare system where patients are
            empowered with their health information, allowing them to make
            informed decisions. We are continually investing in advanced
            technology to enhance our services, ensuring that patients have
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-8">
            ...
            cutting-edge technology with compassionate care. Our patient
            management system allows us to keep track of every patient’s
